...

  {
    ...
    children: [
      ...
      // Hospital information
      {
        ...
        meta: { title: '医院信息', keepAlive: true, icon: bxAnaalyse },
        redirect: '/hospital-information/list',
        component: PageView,
        children: [
          {
            path: '/hospital-information/list',
            name: 'hospital-information-list',
            component: () => import('@/views/hospital-information/HospitalList'),
            meta: { title: '医院信息查询', keepAlive: false, icon: 'tag' }
          },
          {
            path: '/hospital-information/needs-details',
            name: 'hospital-information-needs-details',
            component: () => import('@/views/system-service/subscribe/SystemServiceSubscribeForm'),
            meta: { title: '医院需求明细', keepAlive: false, icon: 'tag' }
          }
        ]
      }
      // system service
