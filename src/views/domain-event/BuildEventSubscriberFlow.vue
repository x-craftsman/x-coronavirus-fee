    ...
    <a-row>
      <a-col :span="22" :offset="1">
        <a-steps size="default" :current="(this.currentTab - 1)">
          <a-step title="选择系统事件" description="选择要订阅的系统事件" />
          <a-step title="配置处理程序" description="提供事件处理程序" />
          <!-- <a-step title="配置映射逻辑" description="支持多种模式配置" /> -->
          <a-step title="测试处理流程" description="验证处理程序可用性" />
...
<script>
import Step1 from './step-form/EventSelectionForm'
import Step2 from './step-form/EventHandlerForm'
// import Step1 from './step-form/DataSourceHandlerForm'
// import Step2 from './step-form/DataTargetHandlerForm'

import Step3 from './step-form/TestWorkflowForm'
import Step4 from './step-form/CompleteStepForm'
